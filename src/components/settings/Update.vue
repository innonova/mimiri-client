		...
		<div class="overflow-y-auto pb-10">
			<div class="leading-7">
				...
				<div v-if="settingsManager.updateMode === UpdateMode.AutomaticOnIdle" class="mt-1 px-2">
					<li>
						Updates that do not require restart will happen automatically when you are not actively using the app.
					</li>
					...
					<li v-if="isLinux">
						If you have installed via FlatHub or Snap Store updates to the Electron host application will happen through
				...
				<div v-if="settingsManager.updateMode === UpdateMode.ManualOnly" class="mt-1 px-2">
					...
					<li v-if="isAndroid">
						Larger updates will still happen like normal through Google Play (outside our control)
					</li>
				</div>
